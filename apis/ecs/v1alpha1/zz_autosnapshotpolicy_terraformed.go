...
func (mg *AutoSnapshotPolicy) GetTerraformResourceType() string {
	return "alicloud_ecs_auto_snapshot_policy"
}
...
// GetInitParameters of this AutoSnapshotPolicy
func (tr *AutoSnapshotPolicy) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AutoSnapshotPolicy
func (tr *AutoSnapshotPolicy) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
