...
func (in *ListenerInitParameters) DeepCopyInto(out *ListenerInitParameters) {
	*out = *in
	...
	if in.ACLIdsRefs != nil {
		in, out := &in.ACLIdsRefs, &out.ACLIdsRefs
		*out = make([]v1.Reference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ACLIdsSelector != nil {
		in, out := &in.ACLIdsSelector, &out.ACLIdsSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.ACLStatus != nil {
	...
	if in.ProxyProtocolV2Enabled != nil {
		in, out := &in.ProxyProtocolV2Enabled, &out.ProxyProtocolV2Enabled
		*out = new(bool)
		**out = **in
	}
	...
	if in.XForwardedFor != nil {
		...
		*out = make([]XForwardedForInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ListenerObservation) DeepCopyInto(out *ListenerObservation) {
	*out = *in
	...
	if in.XForwardedFor != nil {
		in, out := &in.XForwardedFor, &out.XForwardedFor
		*out = make([]XForwardedForObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *XForwardedForInitParameters) DeepCopyInto(out *XForwardedForInitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new XForwardedForInitParameters.
func (in *XForwardedForInitParameters) DeepCopy() *XForwardedForInitParameters {
	if in == nil {
		return nil
	}
	out := new(XForwardedForInitParameters)
	in.DeepCopyInto(out)
	return out
}
