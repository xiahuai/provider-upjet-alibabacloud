...
// GetInitParameters of this Command
func (tr *Command) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Command
func (tr *Command) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
