...
func (mg *Domain) GetTerraformResourceType() string {
	return "alicloud_cdn_domain_new"
}

// GetConnectionDetailsMapping for this Domain
func (tr *Domain) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"certificate_config[*].private_key": "certificateConfig[*].privateKeySecretRef", "certificate_config[*].server_certificate": "certificateConfig[*].serverCertificateSecretRef"}
}
