...
func (mg *AccountPrivilege) GetTerraformResourceType() string {
	return "alicloud_polardb_account_privilege"
}
...
func (tr *AccountPrivilege) GetObservation() (map[string]any, error) {
...
func (tr *AccountPrivilege) SetObservation(obs map[string]any) error {
...
func (tr *AccountPrivilege) GetParameters() (map[string]any, error) {
...
func (tr *AccountPrivilege) SetParameters(params map[string]any) error {
...
// GetInitParameters of this AccountPrivilege
func (tr *AccountPrivilege) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AccountPrivilege
func (tr *AccountPrivilege) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
