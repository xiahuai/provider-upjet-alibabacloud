...
func (mg *EdgeKubernetes) GetTerraformResourceType() string {
	return "alicloud_cs_edge_kubernetes"
}

// GetConnectionDetailsMapping for this EdgeKubernetes
func (tr *EdgeKubernetes) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"password": "passwordSecretRef"}
}

// GetObservation of this EdgeKubernetes
func (tr *EdgeKubernetes) GetObservation() (map[string]any, error) {
...
// SetObservation for this EdgeKubernetes
func (tr *EdgeKubernetes) SetObservation(obs map[string]any) error {
...
// GetID returns ID of underlying Terraform resource of this EdgeKubernetes
func (tr *EdgeKubernetes) GetID() string {
...
// GetParameters of this EdgeKubernetes
func (tr *EdgeKubernetes) GetParameters() (map[string]any, error) {
...
// SetParameters for this EdgeKubernetes
func (tr *EdgeKubernetes) SetParameters(params map[string]any) error {
...
// GetInitParameters of this EdgeKubernetes
func (tr *EdgeKubernetes) GetInitParameters() (map[string]any, error) {
...
// LateInitialize this EdgeKubernetes using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *EdgeKubernetes) LateInitialize(attrs []byte) (bool, error) {
	params := &EdgeKubernetesParameters{}
