...
import (
	...
	"github.com/crossplane-contrib/provider-upjet-alibabacloud/apis/v1alpha1"
	"github.com/crossplane-contrib/provider-upjet-alibabacloud/config"
	"github.com/crossplane-contrib/provider-upjet-alibabacloud/internal/clients"
	"github.com/crossplane-contrib/provider-upjet-alibabacloud/internal/controller"
	"github.com/crossplane-contrib/provider-upjet-alibabacloud/internal/features"
...
func main() {
	var (
		app                     = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for AlibabaCloud cloudmonitorservice").DefaultEnvars()
	...
	log := logging.NewLogrLogger(zl.WithName("provider-upjet-alibabacloud-cloudmonitorservice"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-upjet-alibabacloud-cloudmonitorservice",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(controller.Setup_cloudmonitorservice(mgr, o), "Cannot setup AlibabaCloud cloudmonitorservice controllers")
